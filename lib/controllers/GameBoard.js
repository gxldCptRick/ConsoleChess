...
export  class GameBoard {
    ...
    getPossibleMovesFor(alpha, numeric){
        let boardPoint = new BoardPoint(alpha, numeric);
    ...
    addKingAndQueen(color) {
        ...
        king.setPosition(new BoardPoint(LowerBounds.x + 3, position));
        queen.setPosition(new BoardPoint(this.xLimit - 4, position));
