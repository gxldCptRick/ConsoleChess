...
export class GameBoard {
    ...
    checkIfColorIsInCheckMate(color) {
        ...
        if (color === PieceColor.White) {
            isInCheckMate = this.checkThePiecesAgainForCheckMate(this.pieces.White);
        } else {
            isInCheckMate = this.checkThePiecesAgainForCheckMate(this.pieces.Black);
        }
        return isInCheckMate;
    }

    checkThePiecesAgainForCheckMate(theGuardians) {
