...
PieceTypes.Pawn.canMoveTo = (currentPosition, nextPosition) => {
    ...
    var isTryingToGoBackward = nextPosition.y < currentPosition;
    var result = isAbleToMove2Spaces && isSameLetter && isMovingForward && isTryingToGoBackward;
    return result;
}
...
var isDifOne = difInX / difInY == 1 || difInY / difInX == 1;
...
PieceTypes.Queen.canMoveTo = (currentPosition, nextPosition) =>{
    var canMove = PieceTypes.Bishop.canMoveTo(currentPosition, nextPosition) || PieceTypes.Rook.canMoveTo(currentPosition, nextPosition);
    return canMove;
}
//King Movement
PieceTypes.King.canMoveTo = (currentPosition, nextPosition) => {
    ...
    var canMoveVertically = difInX == 0 && difInY == 1;
    var canMoveHorizontally = difInX == 1 && difInY == 0;
