...
PieceTypes.Pawn.canCapture = (currentPosition, nextPosition) =>
{
    let canCapture = false;
    if(Pawn.canMoveTo(this.currentPosition, this.nextPosition))
    {
        canCapture = ((this.nextPosition.x - this.currentPosition.x ) == 1 )
